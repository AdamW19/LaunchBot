...
import datetime
from cogs.rotation import Rotation
...
async def generate_gif(rotation_info: SplatoonRotation, channel_id: str, bot: Rotation):
    ...
    client = AsyncClient(session=bot.bot.session)
