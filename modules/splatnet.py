...
class Splatnet(AsyncClient):
    def __init__(self, user_agent="", request_prefix="", request_suffix="", session=None):
        super(Splatnet, self).__init__(user_agent=user_agent, request_prefix=request_prefix,
